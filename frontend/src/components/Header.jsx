...
import NotificationCenter from './NotificationCenter'; // ✅ Import the correct component
import { 
...
function Header({ user, onLogout }) {
  ...
  // Fetch stats loop (Notifications handled by NotificationCenter component)
  useEffect(() => {
    if (!user) return;
    fetchStats();
        ...
        <div className="container header-content">
          ...
          {user ? (
            <div className="user-menu">
              ...
              {/* ✅ FIXED: Use the standalone component instead of duplicate code */}
              <NotificationCenter />
